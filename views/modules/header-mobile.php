                            ...
                            <div class="ps-product--cart-mobile">
                                ...
                                <div class="ps-product__thumbnail">
                                    <a href="<?php echo $path . $item->url_product ?>">
                                        <img
                                            src="img/products/<?php echo $item->url_category ?>/<?php echo $item->image_product ?>">
                                    </a>
                                </div>
                ...
                <div class="ps-block--user-header">
                    <div class="ps-block__left">
                        ...
                        <img class="img-fluid rounded-circle w-50 ml-auto"
                            src="img/users/<?php echo $_SESSION["user"]->id_user ?>/<?php echo $_SESSION["user"]->picture_user ?>">
                        ...
                        <img class="img-fluid rounded-circle w-50 ml-auto"
                            src="<?php echo $_SESSION["user"]->picture_user ?>">
    ...
    <div class="ps-search--mobile">
        ...
        <form class="ps-form--search-mobile">
            <div class="form-group--nest">
                ...
                <button type="button" class="btnSearch" path="<?php echo $path ?>"><i
