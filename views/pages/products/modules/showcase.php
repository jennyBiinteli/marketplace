                            ...
                            <div class="col-lg-2 col-md-4 col-6">
                                ...
                                ======================================-->
                                        ...
                                        <ul class="ps-product__actions">
                                            ...
                                            <!--Vista rapida yendo al producto detalles -->
                                            <!-- <li>
                                            ...
                                            <li>
                                                <a class="btn" onclick='quickview(<?php echo json_encode($item); ?>)'
                                                    data-toggle="modal" data-placement="top" title="PRUEBA"
                                ...
                                ======================================-->
                                    ...
                                    ======================================-->
                                            ...
                                            <a class="ps-product__title"
                                                href="<?php echo $path . $item->url_product ?>">
				...
				======================================-->
                        ...
                        ======================================-->
                            ...
                            ======================================-->
                                            ...
                                            <a class="ps-btn"
                                                onclick="addShoppingCart('<?php echo $item->url_product ?>','<?php echo CurlController::api() ?>', '<?php echo $_SERVER["REQUEST_URI"] ?>', this)"
                                                detailsSC quantitySC>Add to cart</a>

                                            <ul class="ps-product__actions">
                                                <li><a href="<?php echo $path . $item->url_product ?>"><i
                                                            class="icon-eye"></i>View</a></li>
                                                <li><a class="btn"
                                                        onclick="addWishlist('<?php echo $item->url_product ?>','<?php echo CurlController::api() ?>')"><i
                                ...
                                <div class="ps-product__header">
                                    <div class="ps-product__thumbnail" data-vertical="false">
                                        <div class="ps-product__images" data-arrow="true">
                                            <div class="item" text-align="center"><img
                                                    src="img/products/default/no_found.png" width="100%" alt=""
                                                    id="modal-image">
                                            </div>
                                        </div>
                                    </div>
