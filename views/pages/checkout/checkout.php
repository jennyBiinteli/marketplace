                        ...
                        <div class="ps-form__billing-info">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group__content">
                                    ...
                                    <input class="form-control"
                                        value="<?php echo $_SESSION["user"]->displayname_user ?>" type="text" readonly
                                        required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group__content">
                                    ...
                                    <input id="emailOrder" class="form-control" type="email"
                                        value="<?php echo $_SESSION["user"]->email_user ?>" readonly required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group__content">
                                    ...
                                    <select id="countryOrder" class="form-control select2"
                                        onchange="changeCountry(event)" required>

                                        <?php if ($_SESSION["user"]->country_user != null) : ?>

                                        <option
                                            value="<?php echo $_SESSION["user"]->country_user ?>_<?php echo explode("_", $_SESSION["user"]->phone_user)[0] ?>">
                                            <?php echo $_SESSION["user"]->country_user ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group__content">
                                    ...
                                    <input id="cityOrder" class="form-control" type="text"
                                        ...
                                        value="<?php echo $_SESSION["user"]->city_user ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group__content input-group">
                                    ...
                                    <div class="input-group-append">
                                        <span
                                            class="input-group-text dialCode"><?php echo explode("_", $_SESSION["user"]->phone_user)[0] ?></span>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group__content">
                                    ...
                                    <input id="addressOrder" class="form-control" type="text"
                                        ...
                                        value="<?php echo $_SESSION["user"]->address_user ?>" required>
                            ...
                            <div class="content">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="hidden" class="deliveryTime"
                                                            value="<?php echo $pOrder->delivery_time_product ?>">
                                                        ...
                                                        <div class="small text-secondary">
                                                            ...
                                                            <div>Sold By: <a
                                                                    href="<?php echo $path . $pOrder->url_store ?>"><strong><?php echo $pOrder->name_store ?></strong></a>
                                                            </div>
                                                            ...
                                                            <div class="detailsOrder">
                                                                ...
                                                                <div>
                                                                    <?php echo $detail . ": " . array_values($item)[$key] ?>
                                                                </div>
                                                            ...
                                                            <div>Shipping:
                                                                <?php echo $pOrder->shipping_product * $value["quantity"] ?>
                                                            </div>
                                                    ...
                                                    <td class="text-right">$<span
                                                            class="priceOrder"><?php echo $subTotalOrder ?></span></td>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="ps-radio">
                                        ...
                                        <input class="form-control" type="radio" id="pay-paypal" name="payment-method"
                                            value="paypal" onchange="changeMethodPaid(event)" checked>

                                        <label for="pay-paypal">Pay with paypal? <span><img
                                                    src="img/payment-method/paypal.jpg" class="w-50"></span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="ps-radio">
                                        ...
                                        <input class="form-control" type="radio" id="pay-payu" name="payment-method"
                                            value="payu" onchange="changeMethodPaid(event)">

                                        <label for="pay-payu">Pay with payu? <span><img
                                                    src="img/payment-method/payu.jpg" class="w-50"></span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="ps-radio">
                                        ...
                                        <input class="form-control" type="radio" id="pay-mercadopago"
                                            name="payment-method" value="mercado-pago"
                                            onchange="changeMethodPaid(event)">

                                        <label for="pay-mercadopago">Pay with Mercado Pago? <span><img
                                                    src="img/payment-method/mercado_pago.jpg"
...
if (isset($_REQUEST['transactionState']) && $_REQUEST['transactionState'] == 4 && isset($_REQUEST['reference_pol'])) {
    ...
    echo "<script>console.log($idPayment)(</script>";
