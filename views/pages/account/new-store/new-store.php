                ...
                <div class="ps-page__content text-center row">
                    ...
                    <div class="container">
                        ...
                        <div class="ps-section__header">
                            ...
                            <h4>Join a marketplace where nearly 50 million buyers around <br> the world shop for unique
                                items</h4>
                            ...
                            <div class="col-lg-4 col-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-footer text-center">
                                        ...
                                        <button class="btn btn-biinteli btn-lg" data-toggle="tab" href="#terms"
                                            onclick="goTerms()">
                            ...
                            <div class="col-lg-4 col-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-footer text-center">
                                        ...
                                        <button class="btn btn-biinteli btn-lg disabled btnCreateStore">
                            ...
                            <div class="col-lg-4 col-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-footer text-center">
                                        ...
                                        <button class="btn btn-biinteli btn-lg disabled btnCreateProduct">
